...
//
//class MotorSalterEtiketi : AppCompatActivity() ,MotorEkleInterface {
//
//
//    val ref = FirebaseDatabase.getInstance().reference.child("pm3Elektrik")
//
//    interface motorSalterEtiketInterface{
//
...
//
//        AnaSayfa().motorSalterEtiketGelenVeriler(motorTag,motorMCCYeri,motorGucKW,motorDevir,mContext)
//
//    }
//
//}
